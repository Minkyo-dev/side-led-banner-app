...
const LABELS: Record<RewardAdLabelKey, Record<AppLocaleKey, string>> = {
  ...
  rewardDescription: {
    ko: "광고 1회 시청 후 2시간 동안 동영상 광고 없이 Pro 버전을 사용할 수 있습니다.",
    en: "Watch one ad and use Pro without video ads for 2 hours.",
    ja: "広告を視聴すると、2時間動画広告なしでPro版を利用できます。",
    zhTC: "觀看一次廣告後，即可在2小時內免影片廣告並使用Pro版",
    zhSC: "观看一次广告后，即可在2小时内免视频广告并使用Pro版",
  },
  rewardWatchAd: {
    ko: "광고 보기",
    en: "Watch Ad",
